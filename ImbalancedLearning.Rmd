...
```{r Figure8, eval = TRUE, echo = FALSE, out.width = "450px", out.height = "450px", fig.cap = "\\label{fig:Figure8} Three-class data without any rebalancing (top-left) and with rebalancing using SMOTE (top-right), borderline SMOTE (bottom-left), and ADASYN (bottom-right)."}
